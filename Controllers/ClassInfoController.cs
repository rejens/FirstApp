...
public class ClassInfoController : Controller
{
    ...
    {
        var list = await _context.ClassInfos.ToListAsync();  // get all class info
        return View(list);
    }
    ...
    {
        return View(new ClassInfoVm()); // return view with empty model
    }
    ...
    public async Task<IActionResult> Delete(long id)
    {
        try
        {
            ...
            _context.ClassInfos.Remove(info);// remove class info
